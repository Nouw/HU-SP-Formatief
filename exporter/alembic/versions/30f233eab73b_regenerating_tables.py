...
Revision ID: 30f233eab73b
Revises: ae215961a21a
Create Date: 2020-03-23 21:24:27.426228
...
revision = '30f233eab73b'
down_revision = 'ae215961a21a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['profile_id'], ['profiles.id_pk'], ),
    sa.PrimaryKeyConstraint('id_pk')
    )
